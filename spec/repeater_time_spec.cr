...
describe Cronic::RepeaterTime do
  ...
  it "next future" do
    ...
    t.next(Cronic::PointerDir::Future).begin.should eq Time.local(2006, 8, 17, 4)
    t = Cronic::RepeaterTime.new("13:00")
    t.start = now_time
    t.next(Cronic::PointerDir::Future).begin.should eq Time.local(2006, 8, 17, 13)
    t.next(Cronic::PointerDir::Future).begin.should eq Time.local(2006, 8, 18, 13)
    t = Cronic::RepeaterTime.new("0400")
    t.start = now_time
    t.next(Cronic::PointerDir::Future).begin.should eq Time.local(2006, 8, 17, 4)
    t.next(Cronic::PointerDir::Future).begin.should eq Time.local(2006, 8, 18, 4)
  ...
  it "next past" do
    ...
    t.next(Cronic::PointerDir::Past).begin.should eq Time.local(2006, 8, 15, 16)
    t = Cronic::RepeaterTime.new("13:00")
    t.start = now_time
    t.next(Cronic::PointerDir::Past).begin.should eq Time.local(2006, 8, 16, 13)
    t.next(Cronic::PointerDir::Past).begin.should eq Time.local(2006, 8, 15, 13)
