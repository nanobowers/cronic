...
describe Cronic::RepeaterFortnight do
  it "next future" do
    ...
    next_fortnight = fortnights.next(Cronic::PointerDir::Future).as(Cronic::Timespan)
    next_fortnight.begin.should eq Time.local(2006, 8, 20)
    next_fortnight.end.should eq Time.local(2006, 9, 3)
    next_next_fortnight = fortnights.next(Cronic::PointerDir::Future)
  ...
  it "next past" do
    fortnights = Cronic::RepeaterFortnight.new(:fortnight)
    fortnights.start = now_time
    last_fortnight = fortnights.next(Cronic::PointerDir::Past).as(Cronic::Timespan)
    last_fortnight.begin.should eq Time.local(2006, 7, 30)
    last_fortnight.end.should eq Time.local(2006, 8, 13)
    last_last_fortnight = fortnights.next(Cronic::PointerDir::Past)
  ...
  it "this future" do
    fortnights = Cronic::RepeaterFortnight.new(:fortnight)
    fortnights.start = now_time
    this_fortnight = fortnights.this(Cronic::PointerDir::Future).as(Cronic::Timespan)
  ...
  it "this past" do
    fortnights = Cronic::RepeaterFortnight.new(:fortnight)
    fortnights.start = now_time
    this_fortnight = fortnights.this(Cronic::PointerDir::Past).as(Cronic::Timespan)
