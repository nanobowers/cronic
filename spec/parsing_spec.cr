...
describe "Parsing" do
  ...
  it("handle generic") do
    ...
    time.should be_within(0.001).of(time2)
    ...
    time.should be_within(1.0e-06).of(time2)
    Cronic.parse("1/1/32.1").should be_nil
    time = Cronic.parse("28th", guess: :begin)
    time.should eq Time.new(Time.now.year, Time.now.month, 28)
  end
  it("handle rmn sd") do
    ...
    time.should be_within(0.001).of(Time.local(2007, 5, 28, 17, 32, 19, 764000))
  end
  ...
  it("handle sy sm sd t tz") do
    ...
    time.to_f.should be_within(0.001).of(1309727495.362)
  end
  ...
  it("handle sy sm sd") do
    ...
    time.should be_within(1.0e-06).of( Time.local(2006, 8, 20, 15, 30, 30, 536))
  ...
  it("handle o r g r") do
    ...
    time.begin.should eq Time.local(2007, 3)
    time = parse_now("3rd month next year", guess: false)
  ...
  it("parse guess r") do
    ...
    time = Cronic.parse("5", now: Time.local(2006, 8, 16, 3, 0, 0, 0), ambiguous_time_range: :none)
  ...
  it("parse guess gr") do
    ...
    now = Time.parse("2011-05-27 23:10")
  ...
  it("parse guess s r p") do
    ...
    time = Cronic.parse("2 months ago", now: Time.parse("2007-03-07 23:30"))
  ...
  it("parse guess rmn s r p") do
    ...
    time.should eq Time.local(2003, 9)
  end
  ...
  it("parse span") do
    ...
    span.begin.should eq Time.local(2006, 11)
    span.end.should eq Time.local(2006, 12)
    span = Cronic.parse("weekend", now: (TIME_2006_08_16_14_00_00), guess: false)
  ...
  it("days in november") do
    t1 = Cronic.parse("1st thursday in november", now: Time.local(2007))
    t1.should eq Time.local(2007, 11, 1, 12)
    t1 = Cronic.parse("1st friday in november", now: Time.local(2007))
    t1.should eq Time.local(2007, 11, 2, 12)
    t1 = Cronic.parse("1st saturday in november", now: Time.local(2007))
