...
describe "Parsing" do
  ...
  it("handle generic") do
    ...
    time.should be_close(time2, 0.001)
    ...
    time.should be_close(time2, 1.0e-06)
  ...
  it("handle sy sm sd t tz") do
    ...
    time.to_f.should be_close(1309727495.362, 0.001)
  end
  ...
  it("handle sy sm sd") do
    ...
    time.should be_close( Time.local(2006, 8, 20, 15, 30, 30, 536), 1.0e-06)
