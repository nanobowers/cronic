...
describe "daylight-savings" do
  it "begin past" do
    ...
    t.next(Cronic::PointerDir::Past).begin.should eq Time.local(2008, 3, 9, 21)
    t = Cronic::RepeaterTime.new("400")
    t.start = begin_daylight_savings
    t.next(Cronic::PointerDir::Past).begin.should eq Time.local(2008, 3, 9, 4)
  ...
  it "begin future" do
    ...
    t.next(Cronic::PointerDir::Future).begin.should eq Time.local(2008, 3, 9, 21)
    t = Cronic::RepeaterTime.new("900")
    t.start = Time.local(2008, 3, 9, 22, 0, 0)
    t.next(Cronic::PointerDir::Future).begin.should eq Time.local(2008, 3, 10, 9)
  ...
  it "end past" do
    ...
    t.next(Cronic::PointerDir::Past).begin.should eq Time.local(2008, 11, 2, 21)
    t = Cronic::RepeaterTime.new("400")
    t.start = end_daylight_savings
    t.next(Cronic::PointerDir::Past).begin.should eq Time.local(2008, 11, 2, 4)
    t = Cronic::RepeaterTime.new("0400")
    t.start = end_daylight_savings
    t.next(Cronic::PointerDir::Past).begin.should eq Time.local(2008, 11, 2, 4)
    t = Cronic::RepeaterTime.new("1300")
  ...
  it "end future" do
    ...
    t.next(Cronic::PointerDir::Future).begin.should eq Time.local(2008, 11, 2, 21)
    t = Cronic::RepeaterTime.new("900")
    t.start = Time.local(2008, 11, 2, 22, 0, 0)
    t.next(Cronic::PointerDir::Future).begin.should eq Time.local(2008, 11, 3, 9)
    t = Cronic::RepeaterTime.new("0900")
    t.start = end_daylight_savings
    t.next(Cronic::PointerDir::Future).begin.should eq Time.local(2008, 11, 2, 9)
    t = Cronic::RepeaterTime.new("0400")
    t.start = end_daylight_savings
    t.next(Cronic::PointerDir::Future).begin.should eq Time.local(2008, 11, 3, 4)
  end
end
